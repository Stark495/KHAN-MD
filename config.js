...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "IK~CYpHUKwb#GLWjFh9FyNtnTDDBF1d_nRWjh8LpMsY350NQ_ZlawoA",
// add your Session Id 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY Ultron 👾*",
...
STICKER_NAME: process.env.STICKER_NAME || "ULTRON 👾",
...
LIVE_MSG: process.env.LIVE_MSG || ">HERE I AM MASTER *ULTRON*⚡",
// add alive msg here 
